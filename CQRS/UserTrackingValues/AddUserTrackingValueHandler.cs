...
{
    public record AddUserTrackingValue(int UserTrackingId, string Name, string Description, int Order, UserTrackingType Type, int Min, int? Max, bool Disabled) : IRequest<int>;
