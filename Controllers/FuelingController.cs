...
namespace diet_tracker_api.Controllers
{
    ...
    public class FuelingController
    {
        ...
        public FuelingController(ILogger<NewUserController> logger, DietTrackerDbContext dietTrackerDbContext, IHttpContextAccessor httpContextAccessor)
        {
            _logger = logger;
        ...
        public async Task<ActionResult<int>> Update(int id, Fueling fueling, CancellationToken cancellationToken)
        {
            ...
            if (results != null)
            {
                var newFueling = results with
                {
                    Name = fueling.Name,
                };
                _context.Fuelings.Update(newFueling);
